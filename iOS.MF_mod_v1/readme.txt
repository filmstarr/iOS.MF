[size=2em][b][u]iOS.MF - Theme Functions[/u][/b][/size]

This modification adds extra functions which are optional for the iOS.MF theme.

These functions enable the theme to extend the default SMF behaviour in a number of small ways and are only used in conjunction with iOS.MF.
